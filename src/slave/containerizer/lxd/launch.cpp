...
#include "slave/containerizer/lxd/launch.hpp"
...
const string LxdContainerizerLaunch::NAME = "launch";


LxdContainerizerLaunch::Flags::Flags()
{
...
int LxdContainerizerLaunch::execute()
{
  if (flags.help) {
    cerr << flags.usage();
    return EXIT_SUCCESS;
