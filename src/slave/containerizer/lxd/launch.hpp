...
#ifndef __LXD_CONTAINERIZER_LAUNCH_HPP__
#define __LXD_CONTAINERIZER_LAUNCH_HPP__
...
class LxdContainerizerLaunch : public Subcommand
{
public:
  ...
  LxdContainerizerLaunch() : Subcommand(NAME) {}
...
#endif // __LXD_CONTAINERIZER_LAUNCH_HPP__
